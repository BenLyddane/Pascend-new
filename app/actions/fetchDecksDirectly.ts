...
export async function fetchDecksDirectly(): Promise<DeckWithCards[]> {
  console.log("Fetching decks directly from server action...");
  ...
  try {
    ...
    console.error("Error in fetchDecksDirectly:", error);
    return [];
  }
}
